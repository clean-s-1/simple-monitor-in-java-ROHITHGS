...
public class ChargeRateManipulator implements BMSCalculation{
    static BMSValues bmsValues;
    static  {
        bmsValues = new BMSValues();
        bmsValues.setMin(0.0f);
        bmsValues.setMax(0.8f);
    ...
    public boolean defineBatteryStatus(float value, Languages message) {
        return BMSUtil.batteryConditionCheck(value,new ChargeRateManipulator(),message);
    }
}
